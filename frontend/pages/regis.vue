                    ...
                    <v-card-text class="bg-white">
                        <v-form @submit.prevent="saveMember">
                            <v-row>
                                ...
                                <v-col cols="12" md="12">
                                    <center>
                                        <v-btn type="submit" color="primary" class="text-center ma-3">สมัครสมาชิก</v-btn>
                                        <v-btn type="reset" color="#7d0c14" class="text-center ma-3">ยกเลิก</v-btn>
                                    </center>
                                </v-col>
                            </v-row>
                        </v-form>
                        <p class="text-center text-blue"><nuxt-link to="/">หากมีบัญชีอยู่แล้ว? เข้าสู่ระบบ</nuxt-link></p>
                    </v-card-text>
                </v-card>
            </v-col>
        </v-row>
