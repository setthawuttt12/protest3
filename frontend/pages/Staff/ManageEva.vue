   ...
   <v-container fluid>
    <center>
        <v-row justify="center">
            <v-col cols="12" md="8">
                <v-card color="#7d0c14">
                    <v-card-title class="text-center"><h1>จัดการผู้รับการประเมินผล</h1></v-card-title>
                    <br>
                    <v-card-text class="bg-white">
                        <v-form @submit.prevent="saveMember">
                            <v-row>
                                ...
                                <v-col cols="12" md="12">
                                    <v-select label="ประเภทสมาชิก" :items="['ผู้รับการประเมินผล']" v-model="form.role" :error-messages="error.role" prepend-inner-icon="mdi-account-group"></v-select>
                                </v-col>
                                <v-col cols="12" md="12">
                                    <center>
